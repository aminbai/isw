      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="card mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            <p className="leading-relaxed mb-4">
              হাছিরপাড়া ইসলামী সমাজকল্যাণ পরিষদ একটি অরাজনৈতিক ও অলাভজনক সংস্থা যা ২০১৫ সালে প্রতিষ্ঠিত হয়েছে। আমাদের মূল লক্ষ্য হলো আমাদের সমাজের
            ...
            <p className="leading-relaxed">
              আমাদের সকল কার্যক্রম স্বচ্ছতা, জবাবদিহিতা এবং ইসলামী শরীয়াহর নির্দেশনার ভিত্তিতে পরিচালিত হয়।
            </p>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              <div className="bg-gray-200 w-24 h-24 rounded-full mx-auto mb-4"></div>
              <h4 className="font-semibold text-navy-800">মোহাম্মদ পারবেজ উদ্দীন</h4>
